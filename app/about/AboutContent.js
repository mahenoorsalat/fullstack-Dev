      ...
      <div className="sm:ml-64 ml-0 flex justify-center">
        <div className="w-[90%] sm:w-[80%] pt-20 space-y-20 pb-32">
            ...
            <section className="sm:px-8 px-0 py-12 mb-12" ref={el => (sectionsRef.current["Introduction"] = el)}>
              <div className="sm:flex-row flex-col flex items-start gap-8">
                <div className="flex-1">
                  ...
                  <a href="https://calendly.com/salatmahenoor7-8-6/30min" target="_blank" rel="noopener noreferrer">
                  ...
                  <div className="flex flex-wrap gap-4 items-center mb-6">
                     ...
                     <div className="flex items-center text-gray-700 dark:text-gray-300">
                        ...
                        <span className="text-base">Asia</span>
                    </div>
                  </div>
                ...
                <div className="w-40 h-40 bg-white/30 dark:bg-gray-700/30 backdrop-blur-xl rounded-full border border-gray-200 dark:border-gray-600 overflow-hidden hover:scale-105 transition-all duration-500 flex-shrink-0 shadow-xl">
                    <Image src="/profile.jpeg" alt="Profile" width={200} height={200} className="rounded-full object-cover w-full h-full" />                
                </div>
              </div>
            </section>
            ...
            <section className='sm:px-8 px-0' ref={el => (sectionsRef.current["Work Experience"] = el)}>
              ...
              {/* Add your ExperienceCards here from your original code */}
              <ExperienceCard company="Developer Studios" title="Full-Stack Developer" period="Dec 2025 - Present" description="Working on full-stack projects involving Next.js, Python, AI APIs, and high-performance UI systems." achievements={["Building high-performance UI systems.", "Integrating AI APIs and Python backend logic."]} />
              <ExperienceCard company="Student Diwan, Qatar" title="LMS Developer" period="Nov 2025 - Present" description="Built and managed LMS features for students using React + Node." achievements={["Developed core LMS features for student management.", "Utilized React and Node.js for scalable architecture."]} />
              <ExperienceCard company="Hexoforge LLC" title="Full-Stack Developer" period="Sep 2025 - Present" description="Developed full-stack modules using MERN, Django, and API integrations." achievements={["Integrated complex API workflows.", "Built full-stack modules bridging MERN and Django."]} />
              <ExperienceCard company="GFE Foundation" title="Frontend & Backend Developer" period="2025 - Present" description="Built blockchain-powered dashboards for decentralized energy trading." achievements={["Developed secure frontend interfaces for energy trading.", "Integrated blockchain data visualization."]} />
              <ExperienceCard company="EGMA" title="UI/UX Designer" period="Nov 2024 - Dec 2024" description="Designed responsive prototypes and improved usability by 40%." />
              <ExperienceCard company="Stability Nexus" title="Frontend Developer" period="Oct 2024 - Nov 2024" description="Enhanced mobile responsiveness by 35% and delivered scalable frontend architecture." />
              <ExperienceCard company="AOSSIE" title="Developer Designer" period="Oct 2024 - Nov 2024" description="Created robotic control UI and optimized REST API workflows." />
              <ExperienceCard company="Xorio" title="UI/UX Designer" period="Sep 2024 - Oct 2024" description="Built interactive prototypes aligned with client branding and design systems." />
              <ExperienceCard company="RKWEB" title="Frontend Developer" period="Dec 2023 - Jan 2024" description="Developed and optimized responsive React applications improving load speed by 45%." />
            </section>
            ...
            <section className='sm:px-8 px-0' ref={el => (sectionsRef.current["Technical Skills"] = el)}>
                ...
                <SkillCard title="Frontend Development" description="Expert in building responsive, dynamic, and interactive web applications." tags={["React", "Next.js", "Vue", "Nuxt", "TypeScript", "Tailwind CSS", "GSAP", "Framer Motion", "HTML/CSS", "Vite"]} />
                <SkillCard title="Backend & Database" description="Solid foundation in server-side logic, API development, and database management." tags={["Node.js", "Express.js", "Python", "Django", "FastAPI", "PostgreSQL", "MongoDB", "Supabase", "REST APIs"]} />
                <SkillCard title="AI, Blockchain & Tools" description="Experience with emerging tech and development tools." tags={["AI API Integrations", "Prompt Engineering", "ML Fundamentals", "Web3 Integrations", "Automation Pipelines", "Git/GitHub"]} />
                <SkillCard title="Design & No-Code" description="Creating visually compelling designs and leveraging no-code solutions." tags={["Figma", "Photoshop", "Illustrator", "Webflow", "Framer", "WordPress", "Shopify"]} />
                </div>
            </section>
             ...
             <section className='sm:px-8 px-0' ref={el => (sectionsRef.current["Certifications"] = el)}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <CertificationCard title="Introduction to Google SEO" issuer="UC Davis" date="Jan 2025" icon={faAward} />
                    <CertificationCard title="Responsive Web Design" issuer="freeCodeCamp" date="Nov 2025" />
                    <CertificationCard title="Microsoft Learn Student Ambassador" issuer="Microsoft" date="Sep 2024" icon={faAward} />
                    <CertificationCard title="Foundations of UX Design" issuer="Coursera" date="Jul 2024" />
                    <CertificationCard title="Meta Front-End Development" issuer="Coursera" date="Jul 2024" />
                    <CertificationCard title="UI/UX Certification" issuer="Great Learning" date="May 2024" />
                </div>
            </section>
